...
public class ChatServer implements MessageSocketThreadListener {
    ...
    public void start(int port) {
        ...
        serverSocketThread = new ServerSocketThread((ServerSocketThreadListener) this,"Chat-Server-Socket-Thread", port, 2000);
